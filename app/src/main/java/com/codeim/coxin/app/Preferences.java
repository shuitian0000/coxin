...
public class Preferences {
	...
	public static final String WEIBO_ACCESS_TOKEN_KEY = "weibo_access_token";
	public static final String WEIBO_EXPIRES_IN_KEY = "weibo_expires_in";
	public static final String WEIBO_UID_KEY = "weibo_uid";
	public static final String WEIBO_USERNAME_KEY = "weibo_username";
	public static final String WEIBO_GENDER_KEY = "weibo_gender";
	...
	public static final String CURRENT_USER_IMAGE_URL = "/profileimg/default_image.jpg";
	...
	//the current info information
	public static final String CURRENT_INFO_OWNER_ID ="current_info_owner_id";
	public static final String CURRENT_INFO_OWNER_USERNAME ="current_info_owner_username";
	public static final String CURRENT_INFO_OWNER_NICKNAME ="current_info_owner_nickname";
