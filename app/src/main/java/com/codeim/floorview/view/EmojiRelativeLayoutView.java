 ...
 ******************************************
 */
public class EmojiRelativeLayoutView extends RelativeLayout implements
	...
	public EmojiRelativeLayoutView(Context context) {
		super(context);
		this.context = context;
	}

	public EmojiRelativeLayoutView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}

	public EmojiRelativeLayoutView(Context context, AttributeSet attrs, int defStyle) {
...
//		et_sendmessage = (EditText) findViewById(R.id.status_new_content);
		layout_point_view = (LinearLayout) findViewById(R.id.iv_image);
		
//		et_sendmessage.setOnClickListener(this);
//		findViewById(R.id.menu_emoji).setOnClickListener(this);
//		emojiview = findViewById(R.id.ll_facechoose);
	}
	...
	private void Init_Data() {
		vp_contains.setAdapter(new EmojiViewPagerAdapter(pageViews));
