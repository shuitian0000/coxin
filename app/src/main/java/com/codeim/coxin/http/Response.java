...
public class Response {
	...
	public String asString() throws ResponseException {
		try {
			...
			Log.e("Response asString", e.getMessage(), e);
			throw new ResponseException(e.getMessage(), e);
		}
	}
	 ...
	 * @throws ResponseException
	 */
	public static String entityToString(final HttpEntity entity) throws IOException, ResponseException {
	...
	public static String entityToString_my(final HttpEntity entity) throws IOException, ResponseException {
	...
	public JSONObject asJSONObject() throws ResponseException {
		try {
			...
			Log.i("Response asJSONObject", jsone.getMessage(), jsone);
