...
import com.codeim.coxin.NewActivity;
...
import com.codeim.coxin.ui.module.MenuDialog;
 ...
 */
public class WithHeaderActivity extends BaseNoDoubleClickActivity {
...
//				intent.setClass(v.getContext(), TwitterActivity.class);
				intent.setClass(v.getContext(), NewActivity.class);
				v.getContext().startActivity(intent);
