...
public class PullToRefreshListView extends ListView {
    ...
    /**
     * Avoid pull all the screen height will make header view too large, so make a scale ratio.
     */
    ...
    private void initView(Context context) {
        ...
        mHeader = inflater.inflate(R.layout.comment_pull_to_refresh_header, null);
        ...
        Log.v("PullToRefreshListView-2", String.valueOf(mHeaderHeight));
    ...
    /**
     * When complete refresh data, you must use this method to hide the header view, if not the header view will be
     * shown all the time.
     */
    ...
    public void onRefreshComplete() {
        mState = State.ORIGNAL;
        changeState();
        tv_time.setText(getResources().getString(R.string.update_time) + new Date().toLocaleString());
    }
