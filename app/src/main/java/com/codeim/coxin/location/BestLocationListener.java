...
package com.codeim.coxin.location;
...
public class BestLocationListener extends Observable implements LocationListener {
    ...
    private static final boolean DEBUG = TwitterApplication.DEBUG;  // FoursquaredSettings.LOCATION_DEBUG
    ...
    public boolean isAccurateEnough(Location location) {
        if (location != null && location.hasAccuracy() && location.getAccuracy() <= REQUESTED_FIRST_SEARCH_ACCURACY_IN_METERS) {
