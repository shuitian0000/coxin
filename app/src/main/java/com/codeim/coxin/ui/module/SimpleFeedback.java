...
public class SimpleFeedback implements Feedback, Widget {
	...
	public SimpleFeedback(Context context) {
		mProgress = (ProgressBar) ((Activity) context).findViewById(R.id.progress_bar);
		//mLoadingProgress = (ProgressBar) ((Activity) context).findViewById(R.id.top_refresh_progressBar);
	}
